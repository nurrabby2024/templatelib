"""Preview handling for TemplateLib."""
...
class PreviewHandler:
 """Processes preview requests with retries and timeouts."""
 ...
 """Run a single preview operation."""
 started = time.time()
 attempts = 0
 last_error = None
 ...
 return {"preview": str(payload)[:200], "attempts": 0}
...
def run_preview(payload, **options):
 """Module-level convenience entry point."""
 return PreviewHandler().run(payload, **options)